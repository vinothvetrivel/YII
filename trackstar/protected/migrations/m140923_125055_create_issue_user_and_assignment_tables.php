...
class m140923_125055_create_issue_user_and_assignment_tables extends CDbMigration
{
	public function up()
	{
		// Create Table issue
		...
		// SYNTAX : addForeignKey("key_name","main_table_name","main_field_id",'reference_table_name',"reference_field_name",'OPERTATION',"CONDITION");
